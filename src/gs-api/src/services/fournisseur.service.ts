...
class FournisseurService extends __BaseService {
  ...
  static readonly savePath = '/gestiondestock/v1/fournisseur/create';
  static readonly deletePath = '/gestiondestock/v1/fournisseur/delete/{idFournisseurt}';
  ...
  /**
   * @param idFournisseurt undefined
   */
  deleteResponse(idFournisseurt: number): __Observable<__StrictHttpResponse<null>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/gestiondestock/v1/fournisseur/delete/${idFournisseurt}`,
      __body,
      {
        headers: __headers,
        params: __params,
   ...
   * @param idFournisseurt undefined
   */
  delete(idFournisseurt: number): __Observable<null> {
    return this.deleteResponse(idFournisseurt).pipe(
