...
class EntrepriseService extends __BaseService {
  static readonly findAllPath = '/gestiondestock/v1/entreprise/all';
  static readonly savePath = '/gestiondestock/v1/entreprise/create';
  static readonly deletePath = '/gestiondestock/v1/entreprise/delete/{idEntreprise}';
  static readonly findByIdPath = '/gestiondestock/v1/entreprise/{idEntreprise}';
  ...
  deleteResponse(idEntreprise: number): __Observable<__StrictHttpResponse<null>> {
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/gestiondestock/v1/entreprise/delete/${idEntreprise}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findByIdResponse(idEntreprise: number): __Observable<__StrictHttpResponse<EntrepriseDto>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/gestiondestock/v1/entreprise/${idEntreprise}`,
      __body,
      {
        headers: __headers,
        params: __params,
