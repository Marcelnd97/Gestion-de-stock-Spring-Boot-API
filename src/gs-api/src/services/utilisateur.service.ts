...
class UtilisateurService extends __BaseService {
  static readonly findAllPath = '/gestiondestock/v1/utilisateur/all';
  static readonly savePath = '/gestiondestock/v1/utilisateur/create';
  static readonly deletePath = '/gestiondestock/v1/utilisateur/delete/{idUtilisateur}';
  static readonly findByMailPath = '/gestiondestock/v1/utilisateur/find/{mail}';
  static readonly changerMotDePassePath = '/gestiondestock/v1/utilisateur/update/password';
  static readonly findByIdPath = '/gestiondestock/v1/utilisateur/{idUtilisateur}';
  ...
  saveResponse(body?: UtilisateurDto): __Observable<__StrictHttpResponse<UtilisateurDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/gestiondestock/v1/utilisateur/create`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  deleteResponse(idUtilisateur: number): __Observable<__StrictHttpResponse<null>> {
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/gestiondestock/v1/utilisateur/delete/${idUtilisateur}`,
      __body,
      {
        headers: __headers,
        params: __params,
   ...
   * @return successful operation
   */
  findByMailResponse(mail: string): __Observable<__StrictHttpResponse<UtilisateurDto>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/gestiondestock/v1/utilisateur/find/${mail}`,
      __body,
      {
        headers: __headers,
        params: __params,
   ...
   * @return successful operation
   */
  findByMail(mail: string): __Observable<UtilisateurDto> {
  ...
  changerMotDePasseResponse(body?: ChangerMotDePasseUtilisateurDto): __Observable<__StrictHttpResponse<UtilisateurDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/gestiondestock/v1/utilisateur/update/password`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findByIdResponse(idUtilisateur: number): __Observable<__StrictHttpResponse<UtilisateurDto>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/gestiondestock/v1/utilisateur/${idUtilisateur}`,
      __body,
      {
        headers: __headers,
        params: __params,
